...
public class MyDbEnv {
    ...
    public void setup(File envHome, boolean readOnly)
        ...
        deptDb = myEnv.openDatabase(null,
                                    "DeptDB",
                                     myDbConfig);

        empDb = myEnv.openDatabase(null,
                                    "EnvDb",
                                    myDbConfig);
   ...
   // getter methods
    ...
    public Database getEmpDb() { return empDb; }

    public Database getProfDb() { return profDb; }
